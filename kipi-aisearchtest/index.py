...
PATENT_TABLE_BASE_ROWS = [
    ...
    {"state": "거절", "cpc": "G11C 16/3459<br>G11C 16/24<br>G11C 16/10(i)", "title": "메모리 장치 및 그 동작 방법", "app_no": "1020210025654", "app_date": "20210223", "pub_no": "1020230120033"},
    ...
    <div class="result-view">
      ...
      <aside class="result-side">
        ...
        <div class="side-card ai-card">
          ...
          <div class="summary-box green"><strong>발명의 효과</strong><span>패키지 기판 상부에 인터포저를 배치하고, 인터포저 상부에 프로세싱 소자와 고대역폭 메모리 소자 및 전력 관리 집적 회로 소자를 탑재하며, 인터포저 내부 또는 상부에 인덕터 및 커패시터와 같은 수동소자를 형성한다.</span></div>
